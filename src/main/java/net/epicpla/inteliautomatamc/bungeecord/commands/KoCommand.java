...
public class KoCommand extends Command {
    InteliAutomataBungeecord plugin;

    public KoCommand(InteliAutomataBungeecord plugin, String name, String permission, String... aliases) {
    ...
    public void execute(CommandSender commandSender, String[] strings) {
        if (commandSender instanceof ProxiedPlayer) {
            ...
            commandSender.sendMessage(new TextComponent(plugin.getCore().koMessage));
        }
    }
}
